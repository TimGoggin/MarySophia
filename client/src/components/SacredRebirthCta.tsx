      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <div className="flex justify-center gap-6">
          <button
            ...
            className="bg-transparent hover:bg-[#D4AF37] text-white font-semibold hover:text-white py-3 px-8 border border-white hover:border-transparent rounded-md transition duration-300"
          >
            Book a Session
          </button>
          <a
