...
export default function ServicesSection() {
  const services = [
    {
      id: 1,
      icon: <img src={getImageUrl("icons/angel.svg", { w: 64, h: 64 })} alt="Star" className="w-16 h-16" />,
    ...
    {
      id: 4,
      icon: <img src={getImageUrl("icons/angel2.svg", { w: 64, h: 64 })} alt="Star" className="w-16 h-16" />,
